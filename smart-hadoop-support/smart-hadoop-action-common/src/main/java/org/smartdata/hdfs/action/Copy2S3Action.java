...
@ActionSignature(
    actionId = "copy2s3",
    displayName = "copy2s3",
    usage = HadoopAction.FILE_PATH + " $src " + Copy2S3Action.DEST +
        " $dest " + Copy2S3Action.BUF_SIZE + " $size"
)
public class Copy2S3Action extends HadoopActionWithRemoteClusterSupport {
  public static final String BUF_SIZE = "-bufSize";
  public static final String SRC = FILE_PATH;
