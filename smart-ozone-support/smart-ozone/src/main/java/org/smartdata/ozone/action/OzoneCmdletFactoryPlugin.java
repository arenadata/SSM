...
import org.smartdata.ozone.client.CachingOfsProvider;

@Slf4j
public class OzoneCmdletFactoryPlugin extends HadoopCmdletFactoryPlugin<FileSystem> {

  public OzoneCmdletFactoryPlugin(SmartConf conf,
      UserImpersonationStrategy userImpersonationStrategy) {
    super(conf, new CachingOfsProvider(conf, userImpersonationStrategy));
  }

  @Override
  protected SmartFsType supportedFsType() {
    return SmartFsType.OZONE;
  }
}
