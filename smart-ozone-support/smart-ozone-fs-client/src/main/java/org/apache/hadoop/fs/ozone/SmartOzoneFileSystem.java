...
public class SmartOzoneFileSystem extends OzoneFileSystem {
  ...
  protected OzoneClientAdapter createAdapter(ConfigurationSource conf, String bucketStr, String volumeStr,
    ...
    return new SmartClientAdapter(
        omHost, omPort, conf, volumeStr, bucketStr,
        (OzoneFSStorageStatistics) getOzoneFSOpsCountStatistics());
  }

  @Slf4j
  static class SmartClientAdapter extends OzoneClientAdapterImpl implements SmartOzoneClientAdapter {
    private final FileAccessReportSupport accessReportSupport;

    SmartClientAdapter(
        String omHost, int omPort, ConfigurationSource hadoopConf,
        String volumeStr, String bucketStr, OzoneFSStorageStatistics storageStatistics) throws IOException {
      this(omHost, omPort, hadoopConf, volumeStr, bucketStr, storageStatistics,
    ...
    SmartClientAdapter(
      ...
      super(omHost, omPort, hadoopConf, volumeStr, bucketStr, storageStatistics);
      this.accessReportSupport = new FileAccessReportSupport(ssmClient, volumeStr, bucketStr);
    }
