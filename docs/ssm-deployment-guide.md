...
----------------------------------------------------------------------------------
Please follow the below configuration guide to integrate SSM with ADH or Apache Hadoop.
Integration with [ADH](https://docs.arenadata.io/en/landing-adh/index.html) is not required, SSM is included in the delivery.
