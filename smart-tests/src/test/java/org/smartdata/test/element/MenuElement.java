...
public interface MenuElement {
  SelenideElement USERNAME = $x(
      "//*[contains(@class, 'systemMenu')]//button[1]//*[contains(@class, 'leftBarMenuItem__label')]");
  ...
  SelenideElement LOGOUT_CONFIRMATION_MODAL_X_BUTTON = LOGOUT_CONFIRMATION_MODAL.$x(
      ".//button[contains(@class, 'dialog__close')]");
}
