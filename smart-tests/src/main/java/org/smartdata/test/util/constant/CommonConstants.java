...
public class CommonConstants {
  ...
  public static final String MULTIHOST_CLUSTER_COMPOSE = "target/test-classes/env/multihost/docker-compose.yaml";
  public static final String HMS_CLUSTER_COMPOSE = "target/test-classes/env/hms-cluster/docker-compose.yaml";
