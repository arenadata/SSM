 ...
 */
package org.smartdata.hive.config;

import org.smartdata.retry.RetryStrategy;

// todo rename
public class ConfigurationKeys {
  public static final String HMS_EVENT_FETCH_ENABLED = "todo.wip.enabled";
  public static final boolean HMS_EVENT_FETCH_ENABLED_DEFALT = false;
